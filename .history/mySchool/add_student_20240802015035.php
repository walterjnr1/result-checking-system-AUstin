             ...
             echo '</select>';
			     ?>                       
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                <input name="photo" type="file" class="inputFile" accept="image/png,image/jpeg,image/jpg" onChange="display_img(this)" style="display: none;"/>
                                <img src="../uploadImage/student/no_image.jpg" alt="student image" width="80" height="69" id="logo-img">                                </p>
                              </div>
                              </div>
