  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
          ...
          <tbody>
          <?php 
$data = $dbh->query("SELECT * FROM examsresultstbl where SchRegCode='$SchRegCode' ORDER BY id DESC ")->fetchAll();
$cnt=1;
          ...
          ?>
            ...
            <td><?php echo $cnt;  ?></td>
               ...
               <td><?php echo $row['ResultID'];  ?> <?php echo $row['OtherName'];  ?> <?php echo $row['Surname'];  ?></td>
