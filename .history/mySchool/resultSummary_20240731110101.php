  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
          ...
          <tbody>
          <?php 
$data = $dbh->query("SELECT rs.ResultID,c.classname,rs.Term,rs.ExamsYear,et.exam_name FROM tblresultsummary rs INNER JOIN tblclass c ON rs.class = c.id INNER JOIN tblexamtype et ON rs.ExamsType = et.id WHERE rs.SchRegCode = '$SchRegCode'
ORDER BY 
    rs.id DESC
")->fetchAll();$cnt=1;
