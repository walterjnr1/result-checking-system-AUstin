...
<body>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
              ...
              <tr>
				...
				<div class="card" id="card" >
                    <div class="card-header">
                      <p align="center" class="style8">Student Report by class (<?php echo $query_class; ?>) <a href="class_report.php"><span class="style12">&lt;&lt; Back</span> </a></p>
                    </div>
                  <!-- /.card-header -->
                    <div class="card-body">
        ...
        LEFT JOIN tblclass class ON student.CurClass = class.id where student.CurClass = '$query' and school.SchRegCode = '$SchRegCode' ORDER BY student.FirstName DESC")->fetchAll();       
        $cnt=1;
        foreach ($data as $row) {
        ?>
                          <tr class="gradeX">
