...
<div class="wrapper boxed-wrapper">
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i>Student Report (General Query)</li>
      </ol>
    </div>
     <p align="center">	
	   			<?php if($success){?>
        ...
        <div class="col-lg-6">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0">Generate Student Report Based on class</h5>
            </div>
            <div class="card-body">
            <form action="report_student_general" method="post">
              <div class="form-group">
                <label for="exampleInputEmail1">Class</label>
                <input type="text" size="77" name="txtsearch" value="" class="form-control">
      
            </div>
             
            
              <button type="submit" name="btnsearch" class="btn btn-success">Submit</button>
            </form>
            </div>
          </div>
        </div>
