...
$sql = "SELECT * FROM tblresultsummary where ResultID ='$resultID' or class='$class' and ExamsYear='$examyear' and Term='$term' and ExamsType='$examtype' and ExamsType='$examtype'";
