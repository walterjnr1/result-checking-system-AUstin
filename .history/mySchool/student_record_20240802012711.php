        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <a class="btn btn-success btn-rounded" href="add_student">Add Student</a>
...
{ ?>
                        ...
                        <?php } ?>
	                      <a href="delete_student.php?id=<?php echo $row['StuAdmNo'];?>" onClick="return deldata('<?php echo $row['FirstName']; ?>');"><i class="fa fa-trash" title="Delete Student Account"></i> </a>		
                           ...
                           <a href="edit_photo.php?StuAdmNo=<?php echo $row['StuAdmNo'];?>" ><i class="fa fa-upload" title="Edit Student Account"></i> </a> 
