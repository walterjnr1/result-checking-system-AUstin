...
$mail->send();
        ...
        $_SESSION['success']='Student registration Was successful . Student Details Sent to parent Email and Phone.';
        //$success = "School Added successfully...";
      } catch (Exception $e) {
        $_SESSION['success'] = "Problem adding School. Mailer Error: {$mail->ErrorInfo}";
      }
    }
  }
