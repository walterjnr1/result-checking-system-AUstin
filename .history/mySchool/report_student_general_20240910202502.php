  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        $data = $dbh->query("SELECT student.*, school.*, class.* FROM studentadmissiontbl student 
                             ...
                             LEFT JOIN tblclass class ON student.CurClass = class.id WHERE student.FirstName = '$query' or student.Surname = '$query' or student.otherName = '$query' or student.sex = '$query' or student.StuAdmNo = '$query' or student.parentName = '$query' or student.parentPhone = '$query' or student.parentEmail = '$query' AND school.SchRegCode='$SchRegCode' ORDER BY student.FirstName DESC")->fetchAll();
        $cnt=1;
        foreach ($data as $row) {
        ?>
                          <tr class="gradeX">
