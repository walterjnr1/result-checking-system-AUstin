...
<body>
  ...
  <div id="wrapper">
    ...
    <a class="btn btn-success btn-rounded" name="generate-btn" data-toggle="modal" data-target="#generateidcard">Generate Bulk ID Card</a>
          ...
          <tbody>
		    <?php 
          $data = $dbh->query("SELECT tblclass.*, studentadmissiontbl.* FROM studentadmissiontbl LEFT JOIN tblclass ON studentadmissiontbl.CurClass  = tblclass.id where studentadmissiontbl.SchRegCode='$SchRegCode' ORDER BY studentadmissiontbl.FirstName DESC ")->fetchAll();   
        $cnt=1;
