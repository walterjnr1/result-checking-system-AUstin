...
$sql = "SELECT * FROM tblresultsummary where ResultID ='$resultID' or class='$class' and ExamsYear='$examyear' and Term='$term' and ExamsType='$examtype' and SchRegCode='$examtype'";
...
$query = "INSERT into `tblresultsummary` (SchRegCode,ResultID,class,Term,ExamsYear,ExamsType,totalScore,TExpecSc,AVGSc,TeachRmk)
VALUES ('$SchRegCode','$resultID','$class','$term','$exam','$examyear','$examtype''$totalScore','$totalEpectedMark','$avg','$teacherRemark')";
$result = mysqli_query($conn,$query);
if($result){
