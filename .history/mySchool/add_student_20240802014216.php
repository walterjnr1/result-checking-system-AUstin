            ...
            <div class="col-lg-7">
             ...
             echo '</select>';
			     ?>                       
                              ...
                              <div class="form-group">
                              <label class="col-sm-2 control-label">Parent Email</label>
                              <div class="col-sm-10">                                   <img src="../uploadImage/student/no_image.jpg" alt="user image" width="87" height="77" id="logo-img">                                </p>
                                  <input name="photo" type="file" class="form-control" accept="image/png,image/jpeg,image/jpg" onChange="display_img(this)"/>
                             </div>
                             </div>
                              <div class="hr-line-dashed"></div>
                              <div class="form-group">
