  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        $data = $dbh->query("SELECT student.*, school.*, class.* 
                             ...
                             WHERE (student.FirstName = '$query' 
                                    OR student.Surname = '$query' 
                                    OR student.otherName = '$query' 
                                    OR student.sex = '$query' 
                                    OR student.StuAdmNo = '$query' 
                                    OR student.parentName = '$query' 
                                    OR student.parentPhone = '$query' 
                                    OR student.parentEmail = '$query') 
