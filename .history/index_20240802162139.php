    ...
    $email= $_POST['txtemail'];
     ...
     $mail = new PHPMailer(true);
         ...
         $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
          $mail->Port       = $em;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
     
        //Recipients
        $mail->setFrom($email, ' Contact us');
        $mail->addAddress($email_website,'Result Checker System');     //Add a recipient
