  ...
  <table class='body-wrap'>
    <tr>
      ...
      <td class='container' width='600'>
            ...
            <tr>
              <td class='content-wrap'>
                <table cellpadding='0' cellspacing='0'>
                  <tr>
                    <td>
					<img src='https://www.allschoolchecks.online/uploadImage/logo/logo.jpg' class='logo' alt='logo'>
		...
		$_SESSION['error'] = "Problem Sending Message. Mailer Error: {$mail->ErrorInfo}";
		}
    }
