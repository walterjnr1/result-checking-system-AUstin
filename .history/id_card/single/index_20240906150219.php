...
if(strlen($_SESSION['login_email'])=="")
  {   
   ...
   //fetch student data
$data = $dbh->query("SELECT student.*, school.* FROM studentadmissiontbl student LEFT JOIN schoolregistrationtbl school ON student.SchRegCode  = school.SchRegCode  where ")->fetchAll();   
