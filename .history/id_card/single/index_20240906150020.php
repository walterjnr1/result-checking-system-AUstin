...
if(strlen($_SESSION['login_email'])=="")
  {   
   ...
   //fetch student data
$data = $dbh->query("SELECT sat.*,sat.status as student_status, srt.* FROM studentadmissiontbl sat LEFT JOIN schoolregistrationtbl srt ON sat.SchRegCode  = srt.SchRegCode  whereORDER BY sat.FirstName DESC ")->fetchAll();   
