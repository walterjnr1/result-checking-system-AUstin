...
if(strlen($_SESSION['login_email'])=="")
  {   
   ...
   //fetch student data
$data = $dbh->query("SELECT student.*, school.* FROM studentadmissiontbl sat LEFT JOIN schoolregistrationtbl school ON sat.SchRegCode  = srt.SchRegCode  where ORDER BY sat.FirstName DESC ")->fetchAll();   
