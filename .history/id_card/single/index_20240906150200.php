...
if(strlen($_SESSION['login_email'])=="")
  {   
   ...
   //fetch student data
$data = $dbh->query("SELECT student.*, school.* FROM studentadmissiontbl student LEFT JOIN schoolregistrationtbl school ON sat.SchRegCode  = school.SchRegCode  where ORDER BY sat.FirstName DESC ")->fetchAll();   
