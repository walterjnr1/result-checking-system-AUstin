    ...
    <div class="content">
      ...
      <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
		  <?php 
          $data = $dbh->query("SELECT schooltable.*,zonetable.name as zoneName ,regiontable.name as regionName,district.name as districtName FROM schoolregistrationtbl schooltable LEFT JOIN schoolregistrationtbl srt ON sat.SchRegCode  = srt.SchRegCode ORDER BY sat.FirstName DESC ")->fetchAll();   
          $cnt=1;
foreach ($data as $row) {
?>
            <tr>
