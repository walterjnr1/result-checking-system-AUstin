...
<script type="text/javascript">
        ...
        function Popup(data) {
            var myWindow = window.open('', 'Student Report by class', 'height=400,width=1100');
            myWindow.document.write('<html><head><title>Student Report by class</title>');
    ...
    <div class="content">
      <div class="row">
        <table width="1049" border="0" align="center">
          <tr>
            <td width="1343" height="214"><div class="card" class="card>
