...
<aside class="main-sidebar"> 
    ...
    <div class="sidebar"> 
      ...
      <li class="treeview"> <a href="#"> <i class="fa fa-map"></i><span>Manage Location</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li><a href="index_scratchcard.php"><i class="fa             <li><a href="zone_record.php"><i class="fa fa-angle-right"></i>Zone Record</a></li>
fa-angle-right"></i> Generate Scratch Card</a></li>
