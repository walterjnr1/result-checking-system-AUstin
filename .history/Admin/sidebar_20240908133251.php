...
<aside class="main-sidebar"> 
    ...
    <div class="sidebar"> 
      ...
      <li class="treeview"> <a href="#"> <i class="fa fa-edit"></i><span>Manage Report</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li><a href="class_report.php"><i class="fa fa-angle-right"></i> Generate Scratch Card</a></li>
            <li><a href="general_report.php"><i class="fa fa-angle-right"></i>Scratch Card Record</a></li>
