...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      ...
      <div class="card-body">
      <h4 class="text-black"> 
      <a href="#"><button type="submit" id="btngenerate" class="btn btn-primary" data-toggle="modal" data-target="#generateidcard">Generate Bulk ID card</button> </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            <label for="term-list">Select Term</label>
            <select class="form-control" id="term-list">
              <option value="">Select Term</option>
              <?php 
              // Assuming you have a table named 'terms' with columns 'id' and 'term_name'
