    ...
    <div class="content">
      <div class="row">
        ...
        $data = $dbh->query("SELECT student.*, school.*, class.* 
                             ...
                             WHERE student.FirstName LIKE '$query' or student.Surname LIKE '$query' or student.otherName LIKE '$query' or student.sex LIKE '$query' or student.StuAdmNo LIKE '$query' or student.pare LIKE '$query' ORDER BY student.FirstName DESC")->fetchAll();
        $cnt=1;
        foreach ($data as $row) {
        ?>
                      <tr class="gradeX">
