...
<style>
    @media print {
  #id-card {
    width: 640px; /* adjust the width to your desired size */
    height: 480px; /* adjust the height to your desired size */
    font-size: 12px; /* adjust the font size to your desired size */
  }
}
</style>
<body>
  ...
  printWindow.document.write(idCardDiv.outerHTML);
