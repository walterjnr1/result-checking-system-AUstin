          ...
          <tr>
            <td width="1343" height="214"><div class="card">
                <div class="card-header">
                  <p align="center" class="style8">Student Report(class) (<?php echo $current_session;  ?>) <a href="class_report.php"><span class="style12">&lt;&lt; Back</span> </a></p>
                </div>
              <!-- /.card-header -->
                <div class="card-body">
                  <table width="97%" align="center" class="table" id="example1">
                    ...
                    <th width="4%"><span class="style16">photo</span></th>
                        <th width="5%"><span class="style16">Admi No</span></th>
                      <th width="6%"><span class="style16">Fullname</span></th>
                      <th width="3%"><span class="style16">Sex</span></th>
                      <th width="8%"><span class="style16">Programme</span></th>
                      <th width="4%"><span class="style16">Class</span></th>
                      <th width="8%"><span class="style16">Boarding Status</span></th>
                      <th width="7%"><span class="style16">Aggregate</span></th>
                      <th width="5%"><span class="style16">Raw score</span></th>
                      <th width="8%"><span class="style16">Enrollment code</span></th>
                      <th width="7%"><span class="style16">JHS Attended</span></th>
                      <th width="4%"><span class="style16">Phone</span></th>
                      <th width="4%"><span class="style16">Email</span></th>
                      <th width="7%"><span class="style16">Father's Name</span></th>
                      <th width="8%"><span class="style16">Father's Occupation</span></th>
                      <th width="6%"><span class="style16">Guardian</span></th>
                      <th width="6%"><span class="style16">House</span></th>
                    </tr>
                    </thead>
