        ...
        <div class="col-lg-6">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0">Generate Student Report Based on Admission Number/Surname/Firstname/Middlename/sex/phone/Email etc</h5>
            </div>
            <div class="card-body">
            <form action="report_student_class.php" method="post">
              <div class="form-group">
                <label for="exampleInputEmail1">Query</label>
                <input class="form-control" name="txtsearch" value="" type="text">
                 </div>
             
            
              <button type="submit" name="btnsearcg" class="btn btn-success">Search</button>
            </form>
            </div>
          </div>
        </div>
