    ...
    <div class="content">
      ...
      <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
		  <?php 
          $data = $dbh->query("SELECT schooltable.*,zonetable.status as student_status, srt.* FROM studentadmissiontbl sat LEFT JOIN schoolregistrationtbl srt ON sat.SchRegCode  = srt.SchRegCode ORDER BY sat.FirstName DESC ")->fetchAll();   
          $cnt=1;
foreach ($data as $row) {
?>
            <tr>
