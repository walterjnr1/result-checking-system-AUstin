...
?>
            <tr>
               ...
               <td>
 <a href="delete_region.php?id=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['name']; ?>');"><i class="fa fa-trash" title="Delete Zone"></i> </a>
 <a href="edit_region.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit" title="Update Zone Details"></i> </a>
