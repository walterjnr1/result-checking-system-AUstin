              ...
              <!-- /.card-header -->
                <div class="card-body">
                  <table width="97%" align="center" class="table" id="example1">
                    ...
                    <tbody>
                      <?php
                        $ret=mysqli_query($conn,"SELECT tblstudents.* FROM tblstudents INNER JOIN tblclass ON tblstudents.class = tblclass.ID INNER JOIN tblhouse ON tblstudents.house = tblhouse.ID where tblstudents.class='$query' order by tblstudents.ID asc");
