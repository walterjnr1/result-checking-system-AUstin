...
$sql = "UPDATE websiteinfo SET website_name=?, email=?, phone1=?,phone2=?, url=?,address1=?,address2=?,account_name=?, bank=?, accountNo=?,SMS_username=? ,SMS_password=? ";
$stmt= $dbh->prepare($sql);
$stmt->execute([$websitename, $email, $phone1, $phone2,$url,$address1,$address2, $accountname, $bankname, $accountNo,$SMS_username,$SMS_password]);
if($stmt) {
