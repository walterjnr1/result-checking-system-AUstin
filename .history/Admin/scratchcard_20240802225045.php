...
<p class="style3">Scratch card</p>
<div class="content-wrapper"><div class="content-header sty-one">
  <ol class="breadcrumb">
      <li><a href="index_scratchcard.php" class="style2">Home</a> </li>
...
<p>      <button onClick="window.print();">Print</button>
</p>
</body>
</html>