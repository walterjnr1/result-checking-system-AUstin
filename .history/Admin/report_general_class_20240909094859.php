    ...
    <div class="content">
      <div class="row">
          ...
          <tr>
            ...
            <div class="card" id="card" >
                <div class="card-header">
                  <p align="center" class="style8">Student Report  <a href="class_report.php"><span class="style12">&lt;&lt; Back</span> </a></p>
                </div>
              <!-- /.card-header -->
                <div class="card-body">
        ...
        $data = $dbh->query("SELECT student.*, school.*, class.* 
                             ...
                             WHERE student.CurClass LIKE '$query' or SurNamestudent.CurClass LIKE '$query' ORDER BY student.FirstName DESC")->fetchAll();
        $cnt=1;
        foreach ($data as $row) {
        ?>
                      <tr class="gradeX">
