...
$region = strtoupper($_POST['txtregion']);

///check if zone already exist 
$stmt = $dbh->prepare("SELECT * FROM tblregion WHERE name=?");
$stmt->execute([$region]); 
$region = $stmt->fetch();

if ($zone) {
$error='This Region Already Exist in our Database ';
} else {

  
 //Add school details
$sql = 'INSERT INTO tblregion(name) VALUES(:name)';
...
header( "refresh:2;url= region_record.php" ); 
$success='Added Region Successfully ';

}else{
$error='Problem Adding New Region ';
}
}
}
...
<title>Add Region|<?php echo $website_name;   ?></title>
...
<div class="wrapper boxed-wrapper">
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i>Add Region</li>
      </ol>
    </div>
     <p align="center">	
	   			<?php if($success){?>
        ...
        <div class="col-lg-6">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0">Add New Region</h5>
            </div>
            <div class="card-body">
            <form  action="" method="POST" >
              <div class="form-group">
                <label for="exampleInputEmail1">Name of Region</label>
                <input class="form-control" name="txtzone" value="<?php if (isset($_POST['txtregion']))?><?php echo $_POST['txtregion']; ?>" type="text">
              </div>
