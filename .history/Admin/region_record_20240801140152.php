...
<title>Region Record|<?php echo $website_name;   ?> </title>
...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Region Record </li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="card-body">
      <h4 class="text-black"> 
        <a href="add_region.php"><button type="submit" name="btnsubmit" class="btn btn-primary">Add Region</button> </a>
 </h4>
      <p>&nbsp;</p>
      <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
		  <?php 
$data = $dbh->query("SELECT *  FROM tblregion order by region_name DESC")->fetchAll();
$cnt=1;
foreach ($data as $row) {
?>
            <tr>
               ...
               <td>
 <a href="delete_region.php?id=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['name']; ?>');"><i class="fa fa-trash" title="Delete Region"></i> </a>
