...
<title>Exam Record|<?php echo $website_name;   ?> </title>
...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Exam Record </li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
		  <?php 
$data = $dbh->query("SELECT *  FROM tblexamtype order by exam_name DESC")->fetchAll();
$cnt=1;
foreach ($data as $row) {
?>
            <tr>
               ...
               <td>
 <a href="delete_exam.php?id=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['exam_name']; ?>');"><i class="fa fa-trash" title="Delete Exam"></i> </a>
 <a href="edit_exam.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit" title="Update Exam Details"></i> </a>
