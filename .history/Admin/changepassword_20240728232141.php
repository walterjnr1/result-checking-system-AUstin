...
<body>
  <table width='80%' cellpadding='0' cellspacing='0' border='0'>
    <tr>
      <td>
        <img src='http://localhost/isupport.ng/icon/logo-dark.png' class='logo' alt='logo'>
        <img src='http://localhost/isupport.ng/icon/logo-dark.png' class='watermark' alt='watermark' style='width: 200px; height: 200px;' >
      </td>
    </tr>
    <tr>
      <td class='email-body'>
