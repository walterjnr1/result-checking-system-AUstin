...
if (isset($_POST['btngenerate'])) {
  ...
  if(mysqli_num_rows($result) > 0) {
   $error = "Batch ID already exists. Please enter a unique batch ID.";
  //$_SESSION['error'] = "Batch ID already exists. Please enter a unique batch ID.";
  ...
  for ($i = 0; $i < $no_card; $i++) {
    ...
    $query = "INSERT INTO tblscratchcard (batchID, pin, serial_no, status, count, date_generated, studentID) VALUES ('$batchID', '$pin', '$serial_no', '0','0', '$current_date','0')";
        ...
        <div class="col-lg-6">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0">Generate Scratch card</h5>
            </div>
            <div class="card-body">
                <form role="form" action="" method="POST">
              <div class="form-group">
                <label for="exampleInputEmail1">No of Card</label>
<input type="number" name="txtno_card" class="form-control"  >
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1">Batch ID</label>
                <input type="text" name="txtbatchID" class="form-control"  >
            </div>
           
			  
              <button type="submit" name="btngenerate" class="btn btn-success">Generate</button>
            </form>
            </div>
          </div>
        </div>
