...
<title>Host Record|<?php echo $row_website['website_name'];   ?></title>
...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Host Record </li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="card-body">
      <h4 class="text-black">Host Record </h4>
      <p>&nbsp;</p>
...
{ ?>
			   ...
			   <?php } else {?>
			    <span class="badge badge-success"><?php echo $row['status'];  ?></span><?php } ?>
			   </td>
			   <td><div align="center">
                                                  <?php if($row['status']=="Inactive")
{ ?>
<a href="Deactivate-activate-user.php?id=<?php echo $row['ID'];?>" onClick="return Activate('<?php echo $row['fullname']; ?>');"><i class="fa fa-check" title="Activate User Account"></i> </a><?php } else {?>
 <a href="Deactivate-activate-user.php?did=<?php echo $row['ID'];?>" onClick="return Deactivate('<?php echo $row['fullname']; ?>');"><i class="fa fa-times" title="Deactivate User Account"></i> </a><?php } ?>
