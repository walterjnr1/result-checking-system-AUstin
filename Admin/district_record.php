...
?>
            <tr>
               ...
               <td>
 <a href="delete_district.php?id=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['DistrictName']; ?>');"><i class="fa fa-trash" title="Delete District"></i> </a>
 <a href="edit_district.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit" title="Update District Details"></i> </a>
