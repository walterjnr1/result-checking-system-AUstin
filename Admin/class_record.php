...
<title>Class Record|<?php echo $website_name;   ?> </title>
...
<script type="text/javascript">
		function deldata(classname){
if(confirm("ARE YOU SURE YOU WISH TO DELETE " + " " + classname + " " + " FROM THE LIST?"))
{
return  true;
}
else {return false;
...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Class Record </li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
		  <?php 
$data = $dbh->query("SELECT *  FROM tblclass order by classname DESC")->fetchAll();
$cnt=1;
foreach ($data as $row) {
?>
            <tr>
               ...
               <td>
 <a href="delete_class.php?id=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['classname']; ?>');"><i class="fa fa-trash" title="Delete Class"></i> </a>
 <a href="edit_class.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit" title="Update Class Details"></i> </a>
