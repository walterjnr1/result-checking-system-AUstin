...
move_uploaded_file($_FILES["logoImage"]["tmp_name"],"../uploadImage/user/" . $_FILES["logoImage"]["name"]);			
$img_location="uploadImage/user/" . $_FILES["logoImage"]["name"];
...
$stmt->execute([$img_location,$email]);
if($stmt) {
...
$success='Profile Editted Successfully. Changes will take place on Next login ';
...
<div class="wrapper boxed-wrapper">
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i>Edit Photo </li>
      </ol>
    </div>
    			<?php if($success){?>
          ...
          <div class="card card-outline">
            ...
            <div class="card-body">
             <form  action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <p class="text-center">
                 <img src="../<?php echo $photo_admin;   ?>" alt="logo" width="178" height="154" id="logo-img">   
				 </p>
